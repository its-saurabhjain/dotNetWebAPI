...
{ 
    public class Startup1
    {
        ...
        /// On sucessful login from AuthServer, Access Token is generated and shared with Web Application and user is redirected to the
        /// application, which directs the user to the resourse server
        /// </summary>
